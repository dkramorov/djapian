...
class ChangeManager(models.Manager):
    ...
    def create_raw(self, object_id, action, content_type):
        """Создание Change из полей object_id, action, content_type
           :param object_id: ид объекта
           :param action: действие (edit)
           :param content_type: тип
        """
        change = self.model(
